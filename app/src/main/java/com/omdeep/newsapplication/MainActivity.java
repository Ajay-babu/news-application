...
//                .placeholder(R.drawable.ic_newspaper);
    ...
    private void getCategories(){
        ...
        categoryRVModalArrayList.add(new CategoryRVModal("Technology",
                "https://images.unsplash.com/photo-1640622308122-b1b0f3cd5a7f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxNnx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60\n" +
                "\n"));
    ...
    private void getNews(String category){
        ...
        String categoryURL = "https://newsapi.org/v2/top-headlines?country=in&category=" + category + "&apikey=ba1c8ecdcf5344929de4ee13d932db2e";
        String url = "https://newsapi.org/v2/top-headlines?country=in&excludeDomains=stackoverflow.com&sortBy=publishedAt&language=en&apikey=ba1c8ecdcf5344929de4ee13d932db2e";
        ...
        call.enqueue(new Callback<NewsModel>() {
            ...
            public void onFailure(Call<NewsModel> call, Throwable t) {
                ...
                Toast.makeText(MainActivity.this,"fails to get news", Toast.LENGTH_SHORT).show();
            }
        });
    }
